const REPO = 'https://github.com/shivamstaq/cgol';
...
export function GithubLink() {
  return (
    <a
      ...
      className="fixed top-4 right-4 z-20 rounded-md border border-border bg-dock p-2 text-text/70 shadow-lg transition-colors hover:text-text"
    >
